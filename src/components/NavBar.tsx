...
<nav className="bg-white border-gray-200  bg-opacity-50 ">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-16 p-4">
    <a className="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">FlipBet</span>
    </a>
    ...
    <div className="hidden w-full md:block md:w-auto mx-8" id="navbar-default">
